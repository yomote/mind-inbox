...
| [`bff-telemetry.md`](bff-telemetry.md)                         | 実環境の BFF を KQL で追う (呼ばれたか / 何 ms で返ったか) / テレメトリに何を載せてよいか                                                                                                            |
| [`mgmt-layer-apply.md`](mgmt-layer-apply.md)                   | 管理系レイヤ (`rg-mgmt-mindbox` / Key Vault + E2E trace 鍵 / バックアップ Storage / 予算) を一度きりで適用する                                                                                       |
| [`e2e-trace-keys.md`](e2e-trace-keys.md)                       | 暗号化された E2E trace を復号する / 鍵を作る・ローテーションする / 復号に使った資格情報を失効させる                                                                                                  |
...
| [`ops-inspect.md`](ops-inspect.md)                             | サンドボックス外の事実 (Azure の実態 / egress の外 / **落ちた run の artifact**) をエージェントが取る                                                                                                |
