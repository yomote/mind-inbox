...
| Application Insights Smart Detection | microsoft.insights/actiongroups | rg-dev-mind-inbox | General Azure resource | Role not yet classified |
| appi-dev-mindbox | microsoft.insights/components | rg-dev-mind-inbox | General Azure resource | Role not yet classified |
