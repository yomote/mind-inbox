...
- 当番セッションは CLAUDE.md の規約 (常設承認 / resolve ルール / hub-and-spoke) に従って**実務を回す**: 滞留 PR のマージ、レビュー指摘への小修正 push と再レビュー依頼、自動起票 Issue の診断、needs-human / Proposed ADR の集計
...
- Routine 作成の人間宿題: #254
- 関連 ADR: [0021](0021-parent-session-as-pm-orchestrator.md) (hub-and-spoke) / [0031](0031-agent-reaches-outside-via-github-actions.md) (外部到達は Actions 経由) / [0035](0035-role-split-across-agents-and-actions.md) (生死が見える場所に置く) / [0036](0036-merge-gate-as-required-check-and-pm-cadence.md) (マージの門と PM リズム)
