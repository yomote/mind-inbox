...
- Status: Accepted (debrief #1, 2026-08-06) — 一部改訂: 実行ダッシュボードの描画面は Projects board から status ページの戦況図に移行 ([ADR 0044](0044-stream-lanes-as-the-project-map.md), 2026-08-11)。「Issues が実行状態の真実 / board に設計を書かない」の核は維持
- Date: 2026-07-19
