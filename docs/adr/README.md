...
⚠️ **欠番は埋めないこと。** 0008 / 0011 / 0014 / 0018〜0022 … が飛んでいるのは、運用系 30 本を
...
開発の運用・プロセスの決め事として書かれていた 30 本は [`archive/`](archive/README.md) にある。
**現行ルールではない** — 今どう動かすかは [`CLAUDE.md`](../../CLAUDE.md) を見ること。

うち 1 本 (旧 0054 / 調査用 read-only 識別) は運用ではなく**開発設備の運用判断**として退避した。
