...
- [0049](0049-github-flow-with-conventional-branch-naming.md) — ブランチ戦略は GitHub Flow と明文化し、命名は Conventional Branch 準拠 + Issue 番号必須にする (`claim/*` `data/*` は予約名前空間) — **Proposed**
