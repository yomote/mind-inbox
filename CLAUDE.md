...
- [`docs/adr/README.md`](docs/adr/README.md) — アーキテクチャ判断の不変記録 (21 本)。**運用・プロセスの決め事は ADR ではない** — 過去に ADR として書かれた 30 本 (運用・プロセス系 29 本 + 開発設備 1 本) は [`docs/adr/archive/`](docs/adr/archive/README.md) にあり、現行ルールではない
