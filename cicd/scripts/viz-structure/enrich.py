...
NAME_OVERRIDES = [
    ...
    # Observability (#478): appi は OTel exporter の出口 (#463 の受け皿)。
    # 根拠は cicd/iac/main-bootstrap.bicep の enableAppInsights 宣言 (既定 true)
    ("microsoft.insights/components", "appi-", "Observability (Application Insights)",
        "OTel exporter sink for BFF telemetry (#463); workspace-based, provisioned by "
        "enableAppInsights (default true) in cicd/iac/main-bootstrap.bicep — telemetry "
        "lands in the central Log Analytics workspace"),
